...
/// @nodoc
mixin _$GatepassEvent {
  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is GatepassEvent);
  }
...
/// @nodoc
class $GatepassEventCopyWith<$Res> {
  $GatepassEventCopyWith(GatepassEvent _, $Res Function(GatepassEvent) __);
}

/// @nodoc

class SearchDialogueDataFetch implements GatepassEvent {
  ...
  /// Create a copy of GatepassEvent
  ...
  @override
  String toString() {
    return 'GatepassEvent.searchDialogueDataFetch(title: $title, division: $division, assetId: $assetId)';
  }
}

/// @nodoc
abstract mixin class $SearchDialogueDataFetchCopyWith<$Res>
    implements $GatepassEventCopyWith<$Res> {
...
class Save implements GatepassEvent {
  ...
  @override
  String toString() {
    return 'GatepassEvent.save(tyrePuncherDetails: $tyrePuncherDetails)';
  }
}
...
mixin _$GatepassState {
  ...
  /// Create a copy of GatepassState
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $GatepassStateCopyWith<GatepassState> get copyWith =>
      _$GatepassStateCopyWithImpl<GatepassState>(
          this as GatepassState, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is GatepassState &&
            const DeepCollectionEquality()
  ...
  @override
  String toString() {
    return 'GatepassState(searchDialogueData: $searchDialogueData, searchDialogueTitle: $searchDialogueTitle, alertTitle: $alertTitle, alertMsg: $alertMsg, maxDocNo: $maxDocNo, isLoading: $isLoading, isVerified: $isVerified)';
  }
}

/// @nodoc
abstract mixin class $GatepassStateCopyWith<$Res> {
  factory $GatepassStateCopyWith(
          GatepassState value, $Res Function(GatepassState) _then) =
      _$GatepassStateCopyWithImpl;
  @useResult
  $Res call(
...
/// @nodoc
class _$GatepassStateCopyWithImpl<$Res>
    implements $GatepassStateCopyWith<$Res> {
  _$GatepassStateCopyWithImpl(this._self, this._then);

  final GatepassState _self;
  final $Res Function(GatepassState) _then;
...
class _GatepassState implements GatepassState {
  _GatepassState(
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$GatepassStateCopyWith<_GatepassState> get copyWith =>
      __$GatepassStateCopyWithImpl<_GatepassState>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _GatepassState &&
            const DeepCollectionEquality()
...
/// @nodoc
abstract mixin class _$GatepassStateCopyWith<$Res>
    implements $GatepassStateCopyWith<$Res> {
  factory _$GatepassStateCopyWith(
          _GatepassState value, $Res Function(_GatepassState) _then) =
      __$GatepassStateCopyWithImpl;
  @override
  @useResult
  $Res call(
      {List<dynamic> searchDialogueData,
...
/// @nodoc
class __$GatepassStateCopyWithImpl<$Res>
    implements _$GatepassStateCopyWith<$Res> {
  __$GatepassStateCopyWithImpl(this._self, this._then);

  final _GatepassState _self;
  final $Res Function(_GatepassState) _then;
