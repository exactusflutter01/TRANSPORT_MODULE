...
mixin _$BatteryState {
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is BatteryState);
  }
...
/// @nodoc
class $BatteryStateCopyWith<$Res> {
  $BatteryStateCopyWith(BatteryState _, $Res Function(BatteryState) __);
}

/// @nodoc

class _Initial implements BatteryState {
  const _Initial();
